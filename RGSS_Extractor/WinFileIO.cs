...
namespace RGSS_Extractor
{
    public class WinFileIO : IDisposable
    {
        ...
        [DllImport("kernel32", SetLastError = true)]
        private unsafe static extern bool ReadFile(IntPtr hFile, void* pBuffer, int NumberOfBytesToRead,
            int* pNumberOfBytesRead, int Overlapped);

        [DllImport("kernel32", SetLastError = true)]
        private unsafe static extern bool WriteFile(IntPtr handle, void* pBuffer, int NumberOfBytesToWrite,
            int* pNumberOfBytesWritten, int Overlapped);
        ...
        public void OpenForReading(string FileName)
        {
            ...
            if (this.pHandle == IntPtr.Zero)
            {
                ...
                ApplicationException ex2 = new ApplicationException("WinFileIO:OpenForReading - Could not open file " +
                                                                    FileName + " - " + ex.Message);
                throw ex2;
            }
        }
        ...
        public void OpenForWriting(string FileName)
        {
            ...
            {
                Win32Exception ex = new Win32Exception();
                ApplicationException ex2 = new ApplicationException("WinFileIO:OpenForWriting - Could not open file " +
                                                                    FileName + " - " + ex.Message);
                throw ex2;
            }
        }
        ...
        public unsafe int Read(int BytesToRead)
        {
            ...
            if (!WinFileIO.ReadFile(this.pHandle, this.pBuffer, BytesToRead, &result, 0))
            {
                ...
                ApplicationException ex2 =
                    new ApplicationException("WinFileIO:Read - Error occurred reading a file. - " + ex.Message);
                throw ex2;
            }
        ...
        public unsafe int ReadUntilEOF()
        {
            ...
            Win32Exception ex = new Win32Exception();
            ApplicationException ex2 =
                new ApplicationException("WinFileIO:ReadUntilEOF - Error occurred reading a file. - " + ex.Message);
            throw ex2;
        }
        ...
        public unsafe int ReadBlocks(int BytesToRead)
        {
            ...
            Win32Exception ex = new Win32Exception();
            ApplicationException ex2 =
                new ApplicationException("WinFileIO:ReadBytes - Error occurred reading a file. - " + ex.Message);
            throw ex2;
        }
        ...
        public unsafe int Write(int BytesToWrite)
        {
            ...
            if (!WinFileIO.WriteFile(this.pHandle, this.pBuffer, BytesToWrite, &result, 0))
            {
                Win32Exception ex = new Win32Exception();
                ApplicationException ex2 =
                    new ApplicationException("WinFileIO:Write - Error occurred writing a file. - " + ex.Message);
                throw ex2;
            }
        ...
        public unsafe int WriteBlocks(int NumBytesToWrite)
        {
            ...
            Win32Exception ex = new Win32Exception();
            ApplicationException ex2 =
                new ApplicationException("WinFileIO:WriteBlocks - Error occurred writing a file. - " + ex.Message);
            throw ex2;
        }
